...
from manager.group import settings_get, settings_set, NEW_MEBMER_CHECK_METHODS

log = manager.logger.getChild("commands.setting")
...
async def setting_command(msg: types.Message):
    ...
    keyboard = InlineKeyboardMarkup(inline_keyboard=[
        ...
        [InlineKeyboardButton(
            text="静默",
            callback_data=json.dumps({"action": "setting_update", "key": "new_member_check_method", "value": "silence"})
        )],
        [InlineKeyboardButton(
            text="无作为",
